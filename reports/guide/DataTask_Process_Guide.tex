% =====================================================================
%  DSP391m · Nhóm 1 — HƯỚNG DẪN CHI TIẾT QUY TRÌNH DATA TASK trên OULAD
...
\lhead{\small\color{cgrey}DSP391m · Nhóm 1}
...
\author{DSP391m · Nhóm 1 · FPT University \\ \small Đề tài: Học máy giải thích được, nhận biết theo thời gian, phát hiện sớm sinh viên nguy cơ (OULAD)}
