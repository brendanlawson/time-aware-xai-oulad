...
\setbeamertemplate{footline}{\hfill\scriptsize\color{gray}%
  DSP391m · Nhóm 1 · \insertframenumber/\inserttotalframenumber\hspace{2mm}\vspace{1mm}}
...
\author{Nhóm 1: T.~B.~Phúc, P.~M.~Đức, P.~V.~Khoa, N.~T.~Bình, N.~V.~An, L.~Q.~T.~Sơn}
\institute{Đại học FPT, Hà Nội \quad\textbullet\quad GVHD: Nguyễn Thị Hoàng Yến}
