...
Kế hoạch tiếp theo của nhóm, theo đúng luồng phân công. **Một** — em làm Phase 4: áp bốn kỹ thuật xử lý mất cân bằng — **no-resample, class-weight, SMOTE, ADASYN** — lên chính năm mô hình này, vẽ biểu đồ trước–sau, trả lời RQ3. **Hai** — bạn Khoa chạy thực nghiệm qua **sáu mốc thời gian** dựng đường cong hiệu năng, trả lời RQ1. **Ba** — bạn Bình làm lớp giải thích **SHAP/LIME** và đo độ ổn định giải thích cho RQ2. **Bốn** — bạn Sơn dựng **Streamlit dashboard** đóng gói mô hình. **Năm** — bạn An viết báo cáo cuối và trực quan hóa tổng hợp.
