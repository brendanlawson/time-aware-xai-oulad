% =====================================================================
%  DSP391m · Group 1 — Task 3: Data Collection & Preprocessing (English)
...
\setbeamertemplate{footline}{%
  \hbox{\begin{beamercolorbox}[wd=\paperwidth,ht=2.6ex,dp=1.2ex,leftskip=1.2em,rightskip=1.2em]{}%
    {\color{cgrey}\scriptsize DSP391m · Group 1 · Task 3 — Data Collection \& Preprocessing}%
...
\subtitle{Time-Aware Explainable ML for Early At-Risk Student Detection (OULAD) — Task 3}
\author{Group 1 — DSP391m}
\institute{FPT University \textbullet{} Supervisor: Nguyen Thi Hoang Yen}
\date{Members: Son \textbullet{} Khoa \textbullet{} An \textbullet{} Duc \textbullet{} Phuc \textbullet{} Binh}
...
\begin{frame}[plain]
  \vfill\hspace{1.1em}\begin{minipage}{0.92\textwidth}
    ...
    {\color{white!90}\large\itshape Time-Aware Explainable ML for Early At-Risk Student Detection (OULAD) — Task 3}\\[16pt]
    {\color{white!80}\small DSP391m · Data Science Capstone · Group 1 · FPT University\\
     Supervisor: Nguyen Thi Hoang Yen \quad\textbullet\quad Members: Son · Khoa · An · Duc · Phuc · Binh}
  \end{minipage}\vfill
\end{frame}}
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \wwr{7 raw OULAD tables $\to$ merge $\to$ \code{master_raw} (32{,}593 $\times$ 33) $\to$ cut at 6 time checkpoints $\to$ leakage-safe preprocessing $\to$ train/test.}
          {An ``anchor'' slide so we always know which pipeline step we are in.}
...
% ===================================================================== PART 5
\partframe{5}{Train/Test Split \& Leakage Control}{Khoa}
